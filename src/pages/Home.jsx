...
import logo from "../assets/cds-simplified-logo.png";

const Home = () => {
  return (
    <div>
      <div className="my-0 lg:my-20 mx-8 lg:mx-10 xl:mx-40">
      ...
      <div className="">
        <div className="my-0 lg:my-20 mx-8 lg:mx-20">
          <div className="p-4 lg:p-8 xl:p-14 2xl:p-20 flex  flex-col-reverse lg:flex-row gap-10">
            ...
            <div className="w-full lg:w-2/5">
              <p className="text-3xl xl:text-4xl font-bold text-center lg:text-start">
                Why choose CinqueDev solutions?
              </p>
