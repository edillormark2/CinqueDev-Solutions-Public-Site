      ...
      <div className="flex justify-end gap-20">
        <div>
          <ul className="p-4">
            ...
            <li className="text-gray-500 pb-2 font-semibold hover:text-primary dark:hover:text-primary cursor-pointer text-sm">
              Home
            </li>
            <li className="text-gray-500   text-sm pb-2 font-semibold hover:text-primary dark:hover:text-primary cursor-pointer">
              Services
            </li>
            <li className="text-gray-500   text-sm pb-2 font-semibold hover:text-primary dark:hover:text-primary cursor-pointer">
              About
